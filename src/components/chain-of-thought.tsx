...
const cn = (...args: Array<string | undefined | false>) =>
...
export const ChainOfThoughtItem = ({
  ...
  <div className={cn("text-muted-fg text-sm", className)} {...props}>
    {children}
  </div>
)
...
export const ChainOfThoughtTrigger = ({
  ...
  <CollapsibleTrigger
    className={cn(
      "group text-muted-fg hover:text-fg flex cursor-pointer items-center justify-start gap-1 text-left text-sm transition-colors",
      className,
    )}
    {...props}
  >
