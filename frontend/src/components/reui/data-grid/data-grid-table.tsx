// @ts-nocheck — vendored ReUI component shipped against Base UI; this project uses Radix. Runtime works; type-only mismatches suppressed.
"use client"
            ...
            {table.getVisibleFlatColumns().map((column, colIndex) => (
              <DataGridTableBodyRowSkeletonCell column={column} key={colIndex}>
                {column.columnDef.meta?.skeleton ?? (
                  <Skeleton className="h-4 w-[60%] min-w-16" />
                )}
